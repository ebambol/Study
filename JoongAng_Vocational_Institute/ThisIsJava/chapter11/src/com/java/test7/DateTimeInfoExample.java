...
public class DateTimeInfoExample {
	...
	public static void main(String[] args) {
		...
		System.out.println("서울 존아이디: " + seoulDateTime.getZone());
		System.out.println("서울 존오프셋: " + seoulDateTime.getOffset());
		System.out.println(seoulDateTime.getChronology());	//사용중인 달력 시스템 출력
	}
