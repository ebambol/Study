...
public class DateTimeInfoExample {
	...
	public static void main(String[] args) {
		...
		ZoneId seoulZoned = seoulDateTime.getZone();
		System.out.println("서울 존아이디: " + seoulZoned);
		
		ZoneOffset seoulZoneOffest = seoulDateTime.getOffset();
		System.out.println("서울 존오프셋: " + seoulZoneOffest);
	}
